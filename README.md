...
| :--- | :--- | :--- |
| **v1.1.2 (Latest)** | [**M-DataPlus Setup 1.1.2.exe**](https://github.com/anhnvt4620/M-DataPlus/releases/download/v1.1.2/M-DataPlus.Setup.1.1.2.exe) | Windows 10/11 (Không cần cài thêm .NET) |
